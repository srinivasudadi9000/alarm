...
public class BackgroundService_first extends Service {
    ...
    public IBinder onBind(Intent intent) {
        Log.d("BackgroundService_first", "onBinder service");
        this.intent =intent;
        return null;
    }
    ...
    public void onCreate() {
        ...
        Log.d("BackgroundService_first", "oncreate service");
        sendnotify();
        // startgetlatlong();
    }
    ...
    public void startgetlatlong() {
        ...
        t.scheduleAtFixedRate(new TimerTask() {
            @Override
            public void run() {
                Log.d("BackgroundService_first", "timercalled service");
                sendnotify();
            }
    ...
    private Runnable myTask = new Runnable() {
        public void run() {
            // Do something here
            sendnotify();
            Log.d("BackgroundService_first", "Mytask running service");
    ...
    public void onDestroy() {
        Log.d("BackgroundService_first", "Destroy service");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        Log.d("BackgroundService_first", "again start called service... ");
    ...
    private class JobAsyncTask extends AsyncTask<JobParameters, Void, JobParameters> {
        ...
        @RequiresApi(api = Build.VERSION_CODES.M)
        public JobAsyncTask(BackgroundService_first backgroundServiceFirst) {
...
//            jobService.jobFinished(jobParameters, false);
    ...
    public void sendnotify() {
        Log.d("BackgroundService_first", "sendnotification service");
        ...
        Log.d("BackgroundService_first", "sendnotificationend service");
    }
